<?php
/**
 * Template Name: Tidligere arrangementer
 */
get_header();
?>
<section class="tidligere-page" style="background-color: #FFFDF5; padding: 60px 20px;">
  <div class="container" style="max-width: 1200px; margin: 0 auto;">
    <div class="filter-row">
  <h1 style="color: #333; font-size: 1.8rem; margin-bottom: 10px;">Tidligere arrangementer</h1>
  ...
  Flere arrangementer og opdateringer findes også i vores <a href="https://www.facebook.com/tidslernedk/?locale=da_DK" target="_blank">Facebook-gruppe</a>.
    ...
    <a href="https://tidslerne.nemtilmeld.dk" target="_blank" class="btn magenta">Se arrangementer på NemTilmeld</a>
    </div>
  </div>
</section>
