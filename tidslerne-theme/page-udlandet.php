<?php
/**
 * Template Name: Udlandet
 */
get_header();
?>
<section class="udlandet-page" style="background-color: #FFFDF5; padding: 60px 20px;">
  <div class="container" style="max-width: 1200px; margin: 0 auto;">
    <div class="filter-row">
  <h1 style="color: #333; font-size: 1.8rem; margin-bottom: 10px;">I udlandet</h1>
    ...
    <div class="story-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px;">
      ...
      if ($stories->have_posts()):
        while ($stories->have_posts()): $stories->the_post();
          $image = get_field('image_udlandetbehandling');
          $title = get_field('title_udlandetbehandling') ?: get_the_title();
          $text = get_field('text_udlandetbehandling');
      ?>
